...
export const SHOP: Record<string, ShopItem[]> = {
  ...
  cabinets: [
    ...
    { id: 'cab_holod1', n: 'Холодильник-1', e: '🧊', p: 200, w: 3, h: 3, surface: 'wall' as const, noCollision: true, rarity: 'rare', sprite: '/sprites/objects/wall/Шкаф_Холодильник-1.webp' },
  ],
  posters: [
    ...
    { id: 'poster_imya', n: 'ИМЯ1', e: '🖼️', p: 50, w: 2, h: 3, surface: 'wall' as const, noCollision: true, rarity: 'common', sprite: '/sprites/objects/wall/Плакат_ИМЯ1.webp' },
