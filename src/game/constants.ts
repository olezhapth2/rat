...
export const SHOP: Record<string, ShopItem[]> = {
  ...
  signs: [
    { id: 'sign_alisa', n: 'Алиса', e: '🏷️', p: 0, w: 2, h: 3, surface: 'wall' as const, noCollision: true, sprite: '/sprites/objects/wall/таблички/Плакат_Алиса.webp' },
    { id: 'sign_anya', n: 'Аня', e: '🏷️', p: 0, w: 2, h: 3, surface: 'wall' as const, noCollision: true, sprite: '/sprites/objects/wall/таблички/Плакат_Аня.webp' },
    { id: 'sign_veronika', n: 'Вероника', e: '🏷️', p: 0, w: 2, h: 3, surface: 'wall' as const, noCollision: true, sprite: '/sprites/objects/wall/таблички/Плакат_Вероника.webp' },
    { id: 'sign_diana', n: 'Диана', e: '🏷️', p: 0, w: 2, h: 3, surface: 'wall' as const, noCollision: true, sprite: '/sprites/objects/wall/таблички/Плакат_Диана.webp' },
    { id: 'sign_imya1', n: 'ИМЯ1', e: '🏷️', p: 0, w: 2, h: 3, surface: 'wall' as const, noCollision: true, sprite: '/sprites/objects/wall/таблички/Плакат_ИМЯ1.webp' },
    { id: 'sign_imya1_1', n: 'ИМЯ1-1', e: '🏷️', p: 0, w: 2, h: 3, surface: 'wall' as const, noCollision: true, sprite: '/sprites/objects/wall/таблички/Плакат_ИМЯ1-1.webp' },
    { id: 'sign_imya1_2', n: 'ИМЯ1-2', e: '🏷️', p: 0, w: 2, h: 3, surface: 'wall' as const, noCollision: true, sprite: '/sprites/objects/wall/таблички/Плакат_ИМЯ1-2.webp' },
    { id: 'sign_imya1_3', n: 'ИМЯ1-3', e: '🏷️', p: 0, w: 2, h: 3, surface: 'wall' as const, noCollision: true, sprite: '/sprites/objects/wall/таблички/Плакат_ИМЯ1-3.webp' },
    { id: 'sign_imya1_4', n: 'ИМЯ1-4', e: '🏷️', p: 0, w: 2, h: 3, surface: 'wall' as const, noCollision: true, sprite: '/sprites/objects/wall/таблички/Плакат_ИМЯ1-4.webp' },
    { id: 'sign_imya1_5', n: 'ИМЯ1-5', e: '🏷️', p: 0, w: 2, h: 3, surface: 'wall' as const, noCollision: true, sprite: '/sprites/objects/wall/таблички/Плакат_ИМЯ1-5.webp' },
    { id: 'sign_imya1_6', n: 'ИМЯ1-6', e: '🏷️', p: 0, w: 2, h: 3, surface: 'wall' as const, noCollision: true, sprite: '/sprites/objects/wall/таблички/Плакат_ИМЯ1-6.webp' },
    { id: 'sign_imya1_7', n: 'ИМЯ1-7', e: '🏷️', p: 0, w: 2, h: 3, surface: 'wall' as const, noCollision: true, sprite: '/sprites/objects/wall/таблички/Плакат_ИМЯ1-7.webp' },
    { id: 'sign_kirill', n: 'Кирилл', e: '🏷️', p: 0, w: 2, h: 3, surface: 'wall' as const, noCollision: true, sprite: '/sprites/objects/wall/таблички/Плакат_Кирилл.webp' },
