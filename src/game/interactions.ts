...
export const INTERACTION_ZONES: InteractionZone[] = [
  { id: 'ashtray', x: 37 * TILE, y: 15 * TILE, radius: TILE * 2.5, label: 'ПЕРЕКУР', icon: '🚬' },
  { id: 'bookshelf', x: 36 * TILE, y: 4 * TILE, radius: TILE * 2.5, label: 'ГРНУТЬ КНИГУ', icon: '📖' },
  { id: 'basketball', x: 5 * TILE, y: 12 * TILE, radius: TILE * 3, label: 'БАСКЕТБОЛ', icon: '🏀' },
  { id: 'microwave', x: 37 * TILE, y: 6 * TILE, radius: TILE * 1.5, label: 'МИКРОВОЛНОВКА', icon: '⏱️' },
  { id: 'furniture_toss', x: 39 * TILE, y: 12 * TILE, radius: TILE * 1.5, label: 'СВАЛКА МЕБЕЛИ', icon: '🪑' },
  { id: 'cardgame', x: 38 * TILE, y: 5 * TILE, radius: TILE * 2, label: 'ИГРАТЬ В OKIЯ', icon: '🃏' },
];
